package com.ggkt.wechat.service.impl;

import com.ggkt.courseclient.CourseFeignClient;
import com.ggkt.entity.model.vod.Course;
import com.ggkt.wechat.service.MessageService;
...
public class MessageServiceImpl implements MessageService {
    ...
    public void pushPayMessage(long orderId) {
        String openid = "oBNQ66yDyqk_Z-JQPQpCnRWRmMqk";
        WxMpTemplateMessage templateMessage = WxMpTemplateMessage.builder()
                .toUser(openid)//要推送的用户openid
                .templateId("BkLmKLxpWynpt5Xk3Bx-GGUpLhcKBCvsXzqQYqkTgQM")//模板id
                .url("http://ggtkbackend.vipgz1.91tunnel.com/#/pay/"+orderId)//点击模板消息要访问的网址
                .build();
        //3,如果是正式版发送消息，，这里需要配置你的信息
        templateMessage.addData(new WxMpTemplateData("first", "亲爱的用户：您有一笔订单支付成功。", "#ffff00"));
        templateMessage.addData(new WxMpTemplateData("keyword1", "1314520", "#ffff00"));
